...
def loginservelate():
   ...
   try:  
      ...
      if((str(u_name) == "Munaxxe") and (str(u_password) == "1010")):   # compare ID and Password
...
#####
@app.route('/StoveON',methods = ['POST', 'GET'])                   # If light OFF button press then open this servelet 
def StoveOn():
   global flag 
   try:
      if(flag==1):                                                   # check valid user
         s.write(b'e')                                               # Send 'b' value to proteus software when bulb off detected 
         return render_template("Bulb_Control.html",HTML_address=Url_Address) #Refresh the control panel webpage after button press
      else:
         return render_template("login.html",HTML_address=Url_Address)  # If user name and password is not correct then after button press then jump to login page 
   except:
...
@app.route('/StoveOff',methods = ['POST', 'GET'])                   # If light OFF button press then open this servelet 
def StoveOff():
   global flag 
   try:
      if(flag==1):                                                   # check valid user
         s.write(b'f')                                               # Send 'b' value to proteus software when bulb off detected 
         return render_template("Bulb_Control.html",HTML_address=Url_Address) #Refresh the control panel webpage after button press
      else:
         return render_template("login.html",HTML_address=Url_Address)  # If user name and password is not correct then after button press then jump to login page 
   except:
...
#####
@app.route('/PlugsON',methods = ['POST', 'GET'])                   # If light OFF button press then open this servelet 
def PlugsOn():
   global flag 
   try:
      if(flag==1):                                                   # check valid user
         s.write(b'g')                                               # Send 'b' value to proteus software when bulb off detected 
         return render_template("Bulb_Control.html",HTML_address=Url_Address) #Refresh the control panel webpage after button press
      else:
         return render_template("login.html",HTML_address=Url_Address)  # If user name and password is not correct then after button press then jump to login page 
   except:
...
@app.route('/PlugsOff',methods = ['POST', 'GET'])                   # If light OFF button press then open this servelet 
def PlugsOff():
   global flag 
   try:
      if(flag==1):                                                   # check valid user
         s.write(b'h')                                               # Send 'b' value to proteus software when bulb off detected 
         return render_template("Bulb_Control.html",HTML_address=Url_Address) #Refresh the control panel webpage after button press
      else:
         return render_template("login.html",HTML_address=Url_Address)  # If user name and password is not correct then after button press then jump to login page 
   except:
